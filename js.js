...
// very well done in here Salam, love the legible dry code 
// would like to encourage you to use arrow functions because of how they handle 'this', if things get more complicated than they are here you will need to refactor ( ex. if you add some higher order functions to make it more dry)
// i put a link to an article below that highlights the differences
...
//-----------------getting some ID's---------------------
// love the labels - nit here : inconsistent length and style
...
const start = () => {
	...
	// learn to love arrow functions !
	// read up on differences here https://betterprogramming.pub/difference-between-regular-functions-and-arrow-functions-f65639aba256
